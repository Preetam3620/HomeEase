...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      dispatch_attempts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "dispatch_attempts_provider_id_fkey"
            columns: ["provider_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      provider_assigned_to_job: {
        Args: { _job_id: string; _user_id: string }
        Returns: boolean
      }
      provider_has_dispatch: {
        Args: { _job_id: string; _user_id: string }
        Returns: boolean
      }
      st_3dclosestpoint: {
    ...
    Enums: {
      ...
      attempt_outcome: "IGNORED" | "REJECTED" | "ACCEPTED" | "EXPIRED"
      job_status:
        | "DRAFT"
        | "DISPATCHING"
        | "OFFERED"
